...
import author from "../../images/stenor_author.jpg";
...
const About = () => {
  const [seeMore, setSeeMore] = useState<number>(7);
            ...
            {skills
              ...
              .map((skill, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={seeMore === 7 ? data.skillClass[index] : ""}
                  >
                    <div className="progress grid grid-cols-10 py-2 text-center bg-[#1e2530] rounded-[5px] text-[16px] text-[white] font-[350]">
                      ...
                      <div className="skill-bar col-span-7 rounded-lg bg-black my-[7.5px] mx-[15px]">
                        <div
                          className={style.bar}
